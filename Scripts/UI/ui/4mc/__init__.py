...
MODEL_PATH={'Basic':'../models/basic.pkl','C. elegans':'../models/C.pkl','D. melanogaster':'../models/D.pkl','A. thaliana':'../models/A.pkl','E. coli':'../models/E.pkl','G. subterraneus':'../models/Gsub.pkl','G. pickeringii':'../models/Gpick.pkl'}
def is_number(s):
